...
CREATE TABLE IF NOT EXISTS CURSO(
	...
	CRS_CODIGO INT NOT NULL AUTO_INCREMENT,
...
CREATE TABLE IF NOT EXISTS MATRICULA(
	MTR_ID VARCHAR(14) NOT NULL,
	MTR_ANO INT(4) NOT NULL,
	MTR_SEMESTRE VARCHAR(10) NOT NULL,
	PRIMARY KEY (MTR_ID),
