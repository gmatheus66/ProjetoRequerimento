...
CREATE TABLE MATRICULA(
	...
	CONSTRAINT CRS_CODIGO FOREIGN KEY (CRS_CODIGO)
	REFERENCES CURSO (CRS_CODIGO),
	CONSTRAINT ALN_CPF FOREIGN KEY (ALN_CPF)
...
CREATE TABLE REQUERIMENTO(
	...
	CONSTRAINT ALN_CPF FOREIGN KEY (ALN_CPF)
	REFERENCES ALUNO (ALN_CPF),
	CONSTRAINT FNC_CPF FOREIGN KEY (FNC_CPF)
	REFERENCES FUNCIONARIO (FNC_CPF),
	CONSTRAINT SUBTP_ID FOREIGN KEY (SUBTP_ID)
	REFERENCES SUBTIPO (SUBTP_ID),
	CONSTRAINT ANX_ID FOREIGN KEY (ANX_ID)
...
CREATE TABLE  SUBTIPO(
	...
	CONSTRAINT TP_ID FOREIGN KEY (TP_ID)
...
CREATE TABLE HISTORICO_SITUACAO(
	...
	CONSTRAINT REQ_PROTOCOLO FOREIGN KEY(REQ_PROTOCOLO)
